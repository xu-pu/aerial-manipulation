...
if __name__ == '__main__':
    ...
    # phi
    axs[0].plot(data[:, 0], rad2deg * data[:, 3], color=plot_color)
    axs[0].set_ylim((-50, 50))
    axs[0].set_yticks([-40, 0, 40])
    ...
    # cable angle
    axs[2].plot(data[:, 0], rad2deg * data[:, 10], color=plot_color)
    axs[2].set_ylim((90, 150))
    axs[2].set_yticks([100, 120, 140])

    # thrust
    axs[3].plot(data[:, 0], data[:, 11], color=plot_color)
    ...
    def render():
        ...
        anim.save('vid1-plot.mp4', writer=writer)
