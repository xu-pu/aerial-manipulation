...
if __name__ == '__main__':
    ...
    vid2 = genfromtxt('vid2.csv', delimiter=',')
    ...
    # cable angles
    axs[0].plot(vid2[:, 0], rad2deg * vid2[:, 10], color='tab:blue')
    axs[0].plot(vid3[:, 0], rad2deg * vid3[:, 10], color='tab:orange')
    axs[0].set_ylim((70, 140))
    axs[0].set_yticks([90, 120])
    ...
    def render():
        ...
        anim.save('vid23-plot.mp4', writer=writer)
