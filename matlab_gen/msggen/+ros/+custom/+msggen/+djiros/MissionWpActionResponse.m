classdef MissionWpActionResponse < ros.Message
    %MissionWpActionResponse MATLAB implementation of djiros/MissionWpActionResponse
    ...
    properties (Constant)
        MessageType = 'djiros/MissionWpActionResponse' % The ROS message type
    end
    ...
    methods
        function obj = MissionWpActionResponse(msg)
            %MissionWpActionResponse Construct the message object MissionWpActionResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'MissionWpActionResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'MissionWpActionResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'MissionWpActionResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'MissionWpActionResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.MissionWpActionResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.MissionWpActionResponse;
            obj.reload(strObj);
        end
    end
end
