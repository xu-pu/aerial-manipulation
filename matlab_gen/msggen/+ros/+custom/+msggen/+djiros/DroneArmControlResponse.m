classdef DroneArmControlResponse < ros.Message
    %DroneArmControlResponse MATLAB implementation of djiros/DroneArmControlResponse
    ...
    properties (Constant)
        MessageType = 'djiros/DroneArmControlResponse' % The ROS message type
    end
    ...
    methods
        function obj = DroneArmControlResponse(msg)
            %DroneArmControlResponse Construct the message object DroneArmControlResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'DroneArmControlResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'DroneArmControlResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'DroneArmControlResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'DroneArmControlResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.DroneArmControlResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.DroneArmControlResponse;
            obj.reload(strObj);
        end
    end
end
