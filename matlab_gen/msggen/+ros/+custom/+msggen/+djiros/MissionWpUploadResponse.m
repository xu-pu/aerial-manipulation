classdef MissionWpUploadResponse < ros.Message
    %MissionWpUploadResponse MATLAB implementation of djiros/MissionWpUploadResponse
    ...
    properties (Constant)
        MessageType = 'djiros/MissionWpUploadResponse' % The ROS message type
    end
    ...
    methods
        function obj = MissionWpUploadResponse(msg)
            %MissionWpUploadResponse Construct the message object MissionWpUploadResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'MissionWpUploadResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'MissionWpUploadResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'MissionWpUploadResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'MissionWpUploadResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.MissionWpUploadResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.MissionWpUploadResponse;
            obj.reload(strObj);
        end
    end
end
