classdef MissionHpActionResponse < ros.Message
    %MissionHpActionResponse MATLAB implementation of djiros/MissionHpActionResponse
    ...
    properties (Constant)
        MessageType = 'djiros/MissionHpActionResponse' % The ROS message type
    end
    ...
    methods
        function obj = MissionHpActionResponse(msg)
            %MissionHpActionResponse Construct the message object MissionHpActionResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'MissionHpActionResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpActionResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpActionResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpActionResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.MissionHpActionResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.MissionHpActionResponse;
            obj.reload(strObj);
        end
    end
end
