classdef MissionHpUpdateRadiusResponse < ros.Message
    %MissionHpUpdateRadiusResponse MATLAB implementation of djiros/MissionHpUpdateRadiusResponse
    ...
    properties (Constant)
        MessageType = 'djiros/MissionHpUpdateRadiusResponse' % The ROS message type
    end
    ...
    methods
        function obj = MissionHpUpdateRadiusResponse(msg)
            %MissionHpUpdateRadiusResponse Construct the message object MissionHpUpdateRadiusResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUpdateRadiusResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUpdateRadiusResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUpdateRadiusResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUpdateRadiusResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.MissionHpUpdateRadiusResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.MissionHpUpdateRadiusResponse;
            obj.reload(strObj);
        end
    end
end
