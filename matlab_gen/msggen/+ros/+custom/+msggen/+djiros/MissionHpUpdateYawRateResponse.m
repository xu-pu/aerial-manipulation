classdef MissionHpUpdateYawRateResponse < ros.Message
    %MissionHpUpdateYawRateResponse MATLAB implementation of djiros/MissionHpUpdateYawRateResponse
    ...
    properties (Constant)
        MessageType = 'djiros/MissionHpUpdateYawRateResponse' % The ROS message type
    end
    ...
    methods
        function obj = MissionHpUpdateYawRateResponse(msg)
            %MissionHpUpdateYawRateResponse Construct the message object MissionHpUpdateYawRateResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUpdateYawRateResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUpdateYawRateResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUpdateYawRateResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUpdateYawRateResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.MissionHpUpdateYawRateResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.MissionHpUpdateYawRateResponse;
            obj.reload(strObj);
        end
    end
end
