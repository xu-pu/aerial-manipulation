classdef SDKControlAuthorityResponse < ros.Message
    %SDKControlAuthorityResponse MATLAB implementation of djiros/SDKControlAuthorityResponse
    ...
    properties (Constant)
        MessageType = 'djiros/SDKControlAuthorityResponse' % The ROS message type
    end
    ...
    methods
        function obj = SDKControlAuthorityResponse(msg)
            %SDKControlAuthorityResponse Construct the message object SDKControlAuthorityResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SDKControlAuthorityResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'SDKControlAuthorityResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'SDKControlAuthorityResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'SDKControlAuthorityResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.SDKControlAuthorityResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.SDKControlAuthorityResponse;
            obj.reload(strObj);
        end
    end
end
