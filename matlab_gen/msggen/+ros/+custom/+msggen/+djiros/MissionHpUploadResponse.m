classdef MissionHpUploadResponse < ros.Message
    %MissionHpUploadResponse MATLAB implementation of djiros/MissionHpUploadResponse
    ...
    properties (Constant)
        MessageType = 'djiros/MissionHpUploadResponse' % The ROS message type
    end
    ...
    methods
        function obj = MissionHpUploadResponse(msg)
            %MissionHpUploadResponse Construct the message object MissionHpUploadResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUploadResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUploadResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUploadResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpUploadResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.MissionHpUploadResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.MissionHpUploadResponse;
            obj.reload(strObj);
        end
    end
end
