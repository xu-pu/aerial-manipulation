classdef MissionHpResetYawResponse < ros.Message
    %MissionHpResetYawResponse MATLAB implementation of djiros/MissionHpResetYawResponse
    ...
    properties (Constant)
        MessageType = 'djiros/MissionHpResetYawResponse' % The ROS message type
    end
    ...
    methods
        function obj = MissionHpResetYawResponse(msg)
            %MissionHpResetYawResponse Construct the message object MissionHpResetYawResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'MissionHpResetYawResponse', 'Result');
        ...
        function set.CmdSet(obj, cmdset)
            ...
            validateattributes(cmdset, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpResetYawResponse', 'CmdSet');
        ...
        function set.CmdId(obj, cmdid)
            ...
            validateattributes(cmdid, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpResetYawResponse', 'CmdId');
        ...
        function set.AckData(obj, ackdata)
            ...
            validateattributes(ackdata, {'numeric'}, {'nonempty', 'scalar'}, 'MissionHpResetYawResponse', 'AckData');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.djiros.MissionHpResetYawResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.djiros.MissionHpResetYawResponse;
            obj.reload(strObj);
        end
    end
end
