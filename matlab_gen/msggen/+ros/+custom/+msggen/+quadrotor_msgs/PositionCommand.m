classdef PositionCommand < ros.Message
    ...
    methods
        function obj = PositionCommand(msg)
            %PositionCommand Construct the message object PositionCommand
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'PositionCommand', 'Header');
        ...
        function set.Position(obj, position)
            ...
            validateattributes(position, {obj.GeometryMsgsPointClass}, {'nonempty', 'scalar'}, 'PositionCommand', 'Position');
        ...
        function set.Velocity(obj, velocity)
            ...
            validateattributes(velocity, {obj.GeometryMsgsVector3Class}, {'nonempty', 'scalar'}, 'PositionCommand', 'Velocity');
        ...
        function set.Acceleration(obj, acceleration)
            ...
            validateattributes(acceleration, {obj.GeometryMsgsVector3Class}, {'nonempty', 'scalar'}, 'PositionCommand', 'Acceleration');
        ...
        function set.Yaw(obj, yaw)
            ...
            validateattributes(yaw, {'numeric'}, {'nonempty', 'scalar'}, 'PositionCommand', 'Yaw');
        ...
        function set.YawDot(obj, yawdot)
            ...
            validateattributes(yawdot, {'numeric'}, {'nonempty', 'scalar'}, 'PositionCommand', 'YawDot');
        ...
        function set.TrajectoryId(obj, trajectoryid)
            ...
            validateattributes(trajectoryid, {'numeric'}, {'nonempty', 'scalar'}, 'PositionCommand', 'TrajectoryId');
        ...
        function set.TrajectoryFlag(obj, trajectoryflag)
            ...
            validateattributes(trajectoryflag, {'numeric'}, {'nonempty', 'scalar'}, 'PositionCommand', 'TrajectoryFlag');
        ...
        function set.Kx(obj, kx)
            ...
            validateattributes(kx, {'numeric'}, {'vector', 'numel', 3}, 'PositionCommand', 'Kx');
        ...
        function set.Kv(obj, kv)
            ...
            validateattributes(kv, {'numeric'}, {'vector', 'numel', 3}, 'PositionCommand', 'Kv');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.quadrotor_msgs.PositionCommand.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.quadrotor_msgs.PositionCommand;
            obj.reload(strObj);
        end
    end
end
